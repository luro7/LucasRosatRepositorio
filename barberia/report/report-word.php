...
$section1->addText("REPORTE DE TURNOS",array("size"=>22,"bold"=>true,"align"=>"right"));
...
$table1->addRow();
$table1->addCell(3000)->addText($pacient->nombre." ".$pacient->apellido);
$table1->addCell(3000)->addText($medic->nombre." ".$medic->apellido);
$table1->addCell(3000)->addText($al->fecha." ".$al->hora);
$table1->addCell(3000)->addText($al->getStatus()->nombre);
$table1->addCell(3000)->addText($al->getPayment()->estado);
$table1->addCell(3000)->addText("$ ".number_format($al->precio,2,".",","));
$total += $al->precio;
}
...
$section1->addText("");
$section1->addText("");
$section1->addText("Generado por DaniEntraigasBarbers v2.0");
