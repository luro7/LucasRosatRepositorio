...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-04-2019 a las 00:02:45
...
(1, 'admin', NULL, NULL, NULL, '90b9aa7e25f80cf4f64e990b78a9fc5ebd6cecad', 1, 1, '2019-04-02 17:27:08');
...
ALTER TABLE `reservation`
  ...
  ADD CONSTRAINT `reservation_ibfk_4` FOREIGN KEY (`pacient_id`) REFERENCES `clientes` (`id`),
